...
API_ID = int(environ.get('API_ID', '33763362'))
API_HASH = environ.get('API_HASH', 'd6733eb1ef60bd57a9b1f925f7a6a420')
BOT_TOKEN = environ.get('BOT_TOKEN', '8133451737:AAHMqt7avrcry1PpitE1HB1qZzhDd49oucM')
#---------------------------------------------------------------
#---------------------------------------------------------------
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003867038825'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/farmanmoesvi')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003778199758').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Madhu:Madhu@madhu.7cjjdns.mongodb.net/?appName=Madhu")
DATABASE_NAME = environ.get('DATABASE_NAME', "Madhu")
